...
use Adimeo\Onix\Entity\CodeList\CodeList3;
...
class Product
{
     ...
     * @return mixed
     */
    public function getBarCodePosition()
    {
        return $this->barCodePosition;
    }

    /**
     * @param mixed $barCodePosition
     * @return Product
     */
    public function setBarCodePosition($barCodePosition)
    {
